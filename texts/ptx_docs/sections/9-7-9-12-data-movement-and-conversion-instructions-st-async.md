...
- Requires: Otherwise, the behavior is undefined.
  - The shared memory addresses of destination operand `a` and the *mbarrier object* `mbar` belong to the same CTA within the same cluster as the executing thread.
