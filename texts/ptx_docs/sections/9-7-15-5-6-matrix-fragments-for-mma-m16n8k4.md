...
- Multiplicand A:
  - `.tf32`: The layout of the fragments held by different threads is shown in [Figure 65](#mma-1684-a-tf32). The row and column of a matrix fragment can be computed as:
    .atype
