###### 9.7.15.6.2.2. Matrix Fragments for sparse `mma.m16n8k32` with `.f16` and `.bf16` types
...
- Multiplicand A: The layout of the fragments held by different threads is shown in [Figure 120](#sparse-mma-16832-f16-bf16-a). The row and column of a matrix fragment can be computed as:
  .atype
  ...
  lastcol  = firstcol + 3
  ```
- Multiplicand B: The layout of the fragments held by different threads is shown in [Figure 121](#sparse-mma-16832-f16bf16-b).
  .atype
