##### 9.7.14.16.13. Parallel Synchronization and Communication Instructions: `mbarrier.inval`
...
`mbarrier.inval` invalidates the *mbarrier object* at the location specified by the address operand `addr`. The invalidation is supported for all layouts described in [Layouts of the mbarrier object](#parallel-synchronization-and-communication-instructions-mbarrier-object-layout).
