...
The more specialized form of the permute control uses the two lsbâs of operand `c` (which is typically an address pointer) to control the byte extraction.
