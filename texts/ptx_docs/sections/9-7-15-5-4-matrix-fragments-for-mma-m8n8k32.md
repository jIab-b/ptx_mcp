...
- Multiplicand A: The layout of the fragments held by different threads is shown in [Figure 59](#mma-8832-a-i4). The row and column of a matrix fragment can be computed as:
  .atype
  ...
  ```
- Multiplicand B: The layout of the fragments held by different threads is shown in [Figure 60](#mma-8832-b-i4). The row and column of a matrix fragment can be computed as:
  .btype
  ...
  col = groupID
  ```
- Accumulators (C or D): The layout of the fragments held by different threads is shown in [Figure 61](#mma-8832-c-i4): The row and column of a matrix fragment can be computed as:
  .ctype / .dtype
