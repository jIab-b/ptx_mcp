...
| `.u8` or `.s8` | `.m16n16k16` | B | A vector expression of two `.b32` registers, with each register containing four elements from the matrix. |
|  | `.m8n32k16` | A | A vector expression containing a single `.b32` register containing four elements from the matrix. |
|  | `.m8n32k16` | B | A vector expression of four `.b32` registers, with each register containing four elements from the matrix. |
|  | `.m32n8k16` | A | A vector expression of four `.b32` registers, with each register containing four elements from the matrix. |
|  | `.m32n8k16` | B | A vector expression containing single `.b32` register, with each containing four elements from the matrix. |
...
| `.s32` | `.m8n32k16` | A vector expression of eight `.s32` registers. |
| `.s32` | `.m32n8k16` | A vector expression of eight `.s32` registers. |
...
| `.bf16` | `.m16n16k16` | B | A vector expression of four `.b32` registers, with each register containing two elements from the matrix. |
| `.bf16` | `.m8n32k16` | A | A vector expression containing a two `.b32` registers, with containing two elements from the matrix. |
| `.bf16` | `.m8n32k16` | B | A vector expression of eight `.b32` registers, with each register containing two elements from the matrix. |
| `.bf16` | `.m32n8k16` | A | A vector expression of eight `.b32` registers, with each register containing two elements from the matrix. |
| `.bf16` | `.m32n8k16` | B | A vector expression containing two `.b32` registers, with each containing two elements from the matrix. |
...
| `.tf32` | `.m16n16k8` | B | A vector expression of four `.b32` registers. |
...
| `.s32` | `.m8n8k128` | A vector expression of two `.s32` registers. |
