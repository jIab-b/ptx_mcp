...
- Multiplicand A:
  ...
  - `.tf32` :
    ...
    ```
  - `.f64` : The layout of the fragments held by different threads is shown in [Figure 73](#mma-1688-a-f64). The row and column of a matrix fragment can be computed as:
    .atype
