...
In general, an operandâs type must agree with the corresponding instruction-type modifier. The rules for operand and instruction type conformance are as follows:
...
|  |  | **Operand Type** | **Operand Type** | **Operand Type** | **Operand Type** |
| --- | --- | --- | --- | --- | --- |
|  |  | **.bX** | **.sX** | **.uX** | **.fX** |
| **Instruction Type** | **.bX** | okay | okay | okay | okay |
| **Instruction Type** | **.sX** | okay | okay | okay | invalid |
| **Instruction Type** | **.uX** | okay | okay | okay | invalid |
| **Instruction Type** | **.fX** | okay | invalid | invalid | okay |
