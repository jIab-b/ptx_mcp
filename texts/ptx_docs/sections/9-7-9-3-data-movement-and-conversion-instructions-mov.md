...
- Although only predicate and bit-size types are required, we include the arithmetic types for the programmerâs convenience: their use enhances program readability and allows additional type checking.
