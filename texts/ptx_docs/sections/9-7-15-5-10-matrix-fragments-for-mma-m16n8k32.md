...
- Multiplicand A:
  - `.s4` or `.u4` :
    ...
    | --- | --- | --- |
    | `.s4` / `.u4` | A vector expression containing two `.b32` registers, with each register containing eight `.u4` / `.s4` elements from the matrix A. | a0, a1, â¦, a14, a15 |
  ...
  - `.s8` or `.u8` or `.e4m3` or `.e5m2` or `.e3m2` or `.e2m3` or `.e2m1`:
    ...
    | `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` | A vector expression containing four `.b32` registers, with each register containing four `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` elements from the matrix A. | a0, a1, â¦, a14, a15 |
...
- Multiplicand B:
  ...
  - `.s8` or `.u8` or `.e4m3` or `.e5m2` or `.e3m2` or `.e2m3` or `.e2m1`:
    ...
    Figure 90 MMA .m16n8k32 fragment layout for rows 0â15 of matrix B with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
    
    Figure 91 MMA .m16n8k32 fragment layout for rows 16â31 of matrix B with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
    ...
    col =   groupID
    ```
- Accumulators (C or D): The layout of the fragments held by different threads is shown in [Figure 92](#mma-16832-c). The row and column of a matrix fragment can be computed as:
  .ctype / .dtype
