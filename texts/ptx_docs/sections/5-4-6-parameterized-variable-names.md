...
For example, suppose a program uses a large number, say one hundred, of `.b32` variables, named `%r0`, `%r1`, â¦, `%r99`. These 100 register variables can be declared as follows:
