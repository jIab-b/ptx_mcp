...
The sink symbol â_â may be used in place of the destination operand `d` when `.BoolOp` qualifier is specified.
...
| ta | tb | tc | Oper 0 (False) | Oper 1 (ta & tb & tc) | Oper 2 (ta & tb & ~tc) | â¦ | Oper 254 (ta \| tb \| tc) | Oper 255 (True) |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 0 | 0 | 0 | 0 | 0 | â¦ | 0 | 1 |
| 0 | 0 | 1 | 0 | 0 | 0 | â¦ | 1 | 1 |
| 0 | 1 | 0 | 0 | 0 | 0 | â¦ | 1 | 1 |
...
| 1 | 1 | 0 | 0 | 0 | 1 | â¦ | 1 | 1 |
| 1 | 1 | 1 | 0 | 1 | 0 | â¦ | 1 | 1 |
| **immLut** | **immLut** | **immLut** | **0x0** | **0x80** | **0x40** | **â¦** | **0xFE** | **0xFF** |
