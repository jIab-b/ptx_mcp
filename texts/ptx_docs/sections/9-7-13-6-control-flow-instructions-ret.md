...
Return execution to callerâs environment. A divergent return suspends threads until all threads are ready to return to the caller. This allows multiple divergent `ret` instructions.
