...
- Accumulator D: Matrix fragments for accumulator D are the same as in case of [Matrix Fragments for wgmma.mma_async.m64nNk8](#asynchronous-warpgroup-level-matrix-register-fragment-wgmma-64n8) for the same `.dtype` format.
