...
**Table 48 Zero-Column Mask descriptor layout**
...
| mask1 | â | Columns [N/2, N-1] | Columns [N/4, N/2-1] |
| mask2 | â | â | Columns [N/2, (N/4*3)-1] |
| mask3 | â | â | Columns [(N/4*3), N-1] |

The following examples shows zero-column mask descriptor and their corresponding mask generated:

1. Example 1: M = 128 Input zero-column mask descriptor: Output zero-column mask: 0x0. As Non-Zero Mask field is 0, the mask is 0x0. All the columns of the matrix `B` will be used for the MMA operation.
  Start count
  ...
  0
2. Example 2: M = 128 Input zero-column mask descriptor: Output mask0: 0b â¦ 111 0000 111 0000 (size = N)
  Start count
  ...
  0
3. Example 3: M = 64 Input zero-column mask descriptor: Output mask0: 0b â¦ 111 0000 111 0000 111 Output masl1: 0b â¦ 0000 111 0000 111 0000
  Start count {.., sc1, sc0}
  ...
  0
4. Example 4: M = 32 Input zero-column mask descriptor: Output mask0: 0b â¦ 0000 111 0000 111 Output mask1: 0b â¦ 0000 111 0000 11 Output mask2: 0b â¦ 111 0000 111 00 Output mask3: 0b â¦ 111 0000 111 000 If N = 128 then `B` Matrix with columns from 2 to 129 will be used for the MMA operation, due to the shift of 2.
