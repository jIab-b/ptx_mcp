...
*Causality order* captures how memory operations become visible across threads through synchronizing operations. The axiom âCausalityâ uses this order to constrain the set of write operations from which a read operation may read a value.
...
1 The transitivity of *base causality order* accounts for the âcumulativityâ of synchronizing operations.
