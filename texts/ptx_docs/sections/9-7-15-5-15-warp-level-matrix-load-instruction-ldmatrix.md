...
| `.b6x16_p32` | `.m16n16` | 16 6-bit elements | 32 bits | `.b8x16` (16 8-bit elements) |
| `.b4x16_p64` | `.m8n16` | 16 4-bit elements | 64 bits | `.b8x16` (16 8-bit elements) |
| `.b4x16_p64` | `.m16n16` | 16 4-bit elements | 64 bits | `.b8x16` (16 8-bit elements) |
...
Consecutive instances of row need not be stored contiguously in memory. The eight addresses required for each matrix are provided by eight threads, depending upon the value of `.num` as shown in the following table. Each address corresponds to the start of a matrix row. Addresses addr0âaddr7 correspond to the rows of the first matrix, addresses addr8âaddr15 correspond to the rows of the second matrix, and so on.

| `.num` | Threads 0â7 | Threads 8â15 | Threads 16â23 | Threads 24â31 |
| --- | --- | --- | --- | --- |
| `.x1` | addr0âaddr7 | â | â | â |
| `.x2` | addr0âaddr7 | addr8âaddr15 | â | â |
| `.x4` | addr0âaddr7 | addr8âaddr15 | addr16âaddr23 | addr24âaddr31 |
